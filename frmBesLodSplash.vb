Public NotInheritable Class frmBesLodSplash
    ...
    Private Sub frmBesLodSplash_Expired(ByVal sender As Object, ByVal e As System.EventArgs) Handles timTimer1.Tick
        Me.Close()
        Me.Dispose()
    End Sub
